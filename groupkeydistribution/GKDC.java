    ...
    public GKDC(IpLink network, Ip4AddressPrefix gkdc_addr) throws IOException, NoSuchAlgorithmException, Exception {
        ...
        public void run(){
                ...
                while(!stop){
                    ...
                    System.out.println( ANSI_GREEN + "GKDC received a new join request : " + new String(pktrcv.getData(),0,pktrcv.getLength())+"  in time intervall "+ virtualTime.getValue()  +"\n creating JOIN - RESPONSE " +  ANSI_RESET);
                    /**
                    ...
                    */
                    ...
                    int initInt = virtualTime.getValue(); /*tS.getValue();*/
                    
                    ArrayList<Node> nodeList = new ArrayList<Node>();
                    System.out.println("Sono stati richiesti chiavi dall'intevallo " + (initInt) + "-" + (initInt + finalInt - 1) );
